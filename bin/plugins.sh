...
if [[ $install_recommended_plugins == 'y' ]]; then
    ...
    php ${WPU_PHPCLI} plugin install crop-thumbnails --activate;
    php ${WPU_PHPCLI} plugin install dominant-color-images --activate;
    ...
    php ${WPU_PHPCLI} plugin install imagify;
