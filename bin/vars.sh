...
WPU_SUBMODULES_FORCED_MUPLUGINS="wpu_ux_tweaks wpu_file_cache wpu_health_check_tests wpu_settings_version wpu_admin_protect wpu_super_editor wpuhtaccessprotect";
